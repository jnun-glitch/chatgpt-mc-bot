...
tellraw @a[tag=!theobot] [
  {"text":"[TheoBot] ","color":"gold","bold":true},
  {"selector":"@a[tag=theobot,distance=..0.2,limit=1]"},
  {"text":" id="},{"nbt":"id","storage":"theobot:debug"},
  {"text":" state="},{"nbt":"state","storage":"theobot:debug"},
  {"text":" mode="},{"nbt":"mode","storage":"theobot:debug"},
  {"text":" distX100="},{"nbt":"dist","storage":"theobot:debug"},
  {"text":" hdistX100="},{"nbt":"hdist","storage":"theobot:debug"},
  {"text":" vdistX100="},{"nbt":"vdist","storage":"theobot:debug"},
  {"text":" ping="},{"nbt":"ping","storage":"theobot:debug"},
  {"text":" lastSeen="},{"nbt":"lastseen","storage":"theobot:debug"},
  {"text":" repath="},{"nbt":"repath","storage":"theobot:debug"},
  {"text":" stuck="},{"nbt":"stuck","storage":"theobot:debug"},
  {"text":" diff="},{"nbt":"diff","storage":"theobot:debug"},
  {"text":" profile="},{"nbt":"profile","storage":"theobot:debug"}
]
