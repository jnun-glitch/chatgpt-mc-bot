tellraw @s [
  ...
  {"text":" [Training Bot]","color":"aqua","click_event":{"action":"run_command","command":"/function theobot:bot/spawn_training"}},
  ...
  {"text":" [Training]","color":"aqua","click_event":{"action":"run_command","command":"/function theobot:config/mode/training"}},
