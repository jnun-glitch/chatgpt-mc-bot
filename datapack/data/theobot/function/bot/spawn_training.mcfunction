...
function theobot:herobot/control {selector:"@a[name=TheoTrainer,tag=theobot,limit=1]",action:"autojump true"}
function theobot:herobot/control {selector:"@a[name=TheoTrainer,tag=theobot,limit=1]",action:"ping 50"}
