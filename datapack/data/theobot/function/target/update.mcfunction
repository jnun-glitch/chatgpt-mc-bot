...
execute if entity @p[distance=..32,tag=!theobot,gamemode=!spectator] store result score @a[tag=theobot,distance=..0.2,limit=1] tb.hdist run distance from @a[tag=theobot,distance=..0.2,limit=1] to @p[distance=..32,tag=!theobot,gamemode=!spectator] horizontal e 2
execute if entity @p[distance=..32,tag=!theobot,gamemode=!spectator] store result score @a[tag=theobot,distance=..0.2,limit=1] tb.vdist run distance from @a[tag=theobot,distance=..0.2,limit=1] to @p[distance=..32,tag=!theobot,gamemode=!spectator] vertical e 2
...
execute unless entity @p[distance=..32,tag=!theobot,gamemode=!spectator] run scoreboard players set @a[tag=theobot,distance=..0.2,limit=1] tb.hdist 0
execute unless entity @p[distance=..32,tag=!theobot,gamemode=!spectator] run scoreboard players set @a[tag=theobot,distance=..0.2,limit=1] tb.vdist 0
